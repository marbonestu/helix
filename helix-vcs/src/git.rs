...
pub fn for_each_changed_file(
    ...
    status(&open_repo(cwd, trust_full)?.to_thread_local(), f, true)
}
...
pub fn for_each_changed_file_tracked_only(
    ...
    status(&open_repo(cwd, trust_full)?.to_thread_local(), f, false)
}
...
pub fn for_each_untracked_files(
    ...
    status_untracked_only(&open_repo(cwd, trust_full)?.to_thread_local(), f)
}
